        ...
        <div className="mb-8 relative z-20">
          <div className="relative flex items-center justify-center">
            ...
            <div className="absolute inset-0 z-0 pointer-events-none flex items-center justify-center">
              <div
                className="w-[200px] h-[100px] sm:w-[300px] sm:h-[150px] md:w-[400px] md:h-[200px] rounded-full opacity-40"
                style={{
                  background:
            ...
            <img
              ...
              style={{
                filter:
                  "drop-shadow(0 0 20px rgba(236,72,153,0.5)) drop-shadow(0 0 10px rgba(245,158,11,0.3))",
              }}
            />
          </div>
