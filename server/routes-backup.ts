...
export async function registerRoutes(app: Express): Promise<Server> {
  ...
  try {
    ...
    console.log('📋 Continuing with fallback mode - API responses will be mock data');
  ...
  if (!isDatabaseConnected) {
    console.log("⚠️  Database not connected - API endpoints will return mock responses");
